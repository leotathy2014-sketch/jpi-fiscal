...
import { CalendarDays, Check, ChevronRight, CircleAlert, Eye, FileCode2, FileText, GraduationCap, Mail, MailCheck, MessageCircle, Plus, ReceiptText, RefreshCw, Search, Send, Settings, ShieldCheck, Sparkles, UsersRound, WalletCards, X } from "lucide-react";
  ...
  async function sendCurrentDocument(){
    ...
    try{
      if(deliveryChannel==="whatsapp-manual"){
        ...
        setMessage(deliveryChannel==="agenda-edu"?"Mensagem da Agenda Edu preparada com link seguro e registrada no histórico.":"NFS-e enviada por e-mail e registrada no histórico.");
        await load(true);
      }
