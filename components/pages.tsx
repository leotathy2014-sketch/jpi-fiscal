...
type AgendaStudentDetailsResult={message:string;baseUrl:string;environment:string;student:AgendaStudentListItem|null;responsibles:AgendaStudentListItem[];classrooms:AgendaStudentListItem[];included:unknown[];raw:unknown;attempted:string};
