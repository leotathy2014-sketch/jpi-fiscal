      ...
      {section==="agenda"&&<><div className={isMaster?"integration-agenda-master-grid":"integration-agenda-stack"}><div className="integration-agenda-stack"><form className="communication-channel-card data-form" onSubmit={saveAgenda}>
        ...
        {isMaster&&<aside className="agenda-master-server-card">
          ...
          <dl className="agenda-server-data">
            ...
            <div><dt>Client ID</dt><dd>{config?.agenda_edu_credencial_configurada?"Protegido no servidor":"Não configurado"}</dd></div>
            <div><dt>Client Secret</dt><dd>{config?.agenda_edu_credencial_configurada?"Protegido no servidor":"Não configurado"}</dd></div>
            <div><dt>X-School-Token</dt><dd>{config?.agenda_edu_credencial_configurada?"Protegido no servidor":"Não configurado"}</dd></div>
          ...
          <div className="agenda-server-security"><ShieldCheck/><span><strong>Segredos não exibidos</strong><small>Tokens e senhas permanecem criptografados e nunca são retornados ao navegador.</small></span></div>
